<div class="menu-top"></div>
  <div id="header">
    ...
    <div id="logo">
      <a href="/index.php" title="Home"><img src="<?php echo base_url(); ?>themes/index/images/logo.png" alt=""  />
      </a>
    <h2 class="h2-slogan text-responsive"><i> Asia's informational resource for high quality reel products and accessories of value</i></h2>
    </div> <!--end language-->
  </div> <!--end header-->
<div id="box"></div>
